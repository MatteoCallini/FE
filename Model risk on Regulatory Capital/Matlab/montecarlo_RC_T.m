function [EL_vec, EL, RC, RC_CI, EL_CI] = montecarlo_RC_T(N,k_hat,sigma_k,LGD_cap,sigma_LGD,alpha,t,M,flag,correlation)
    ...
    if flag == 3
        k_MC = k_hat + sigma_k*t(1,:);
        LGD_MC = LGD_cap + sigma_LGD*t(2,:);
        rho = correlation_IRB(normcdf(k_MC));
