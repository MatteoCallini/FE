function price = bachelier_price_spot(Volatilities,Strikes,discounts,Maturities,delta,dt)
    % This function computes the prices of every cap for the 3m Euribor (spot volatilities)
    ...
    for j=1:n % rows
        for i=1:m % coloums
            ...
            price(j,i) = Cap_pricing(Volatilities(1:(index-1),i)',...
